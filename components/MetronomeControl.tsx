...
export default function MetronomeControl({ 
  ...
  const volumeSlider = useDebouncedSlider<number>({
    ...
    onSave: (value) => {
      ...
      success(`Volume set to ${Math.round(value)}%`)
    }
  })
      ...
      <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6">
        ...
        <div className="text-center space-y-4">
          ...
          <Button
            ...
            size="lg"
            className="w-full h-12 sm:h-10 text-base sm:text-sm touch-manipulation font-semibold"
          >
            {isPlaying ? (
              <>
          ...
          <div className="space-y-4 sm:space-y-5 pt-4 border-t">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Button
                ...
                className="h-10 sm:h-8 min-w-[60px] touch-manipulation"
              >
